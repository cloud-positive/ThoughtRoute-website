...
export function Hero() {
    return (
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6 md:px-10 max-w-7xl">
                <div className="max-w-2xl hero-fade-in">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-slate-300 text-sm font-medium mb-8">
                        <span className="text-yellow-400 hero-star-pulse">✦</span>
                    ...
                    {/* Stats Row */}
                    <div className="mt-14 flex items-start gap-10 hero-stats-fade">
                        {[
            ...
            <div
                className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-slate-400 text-sm cursor-pointer z-10 hover:text-white transition-colors hero-bounce"
                onClick={() => {
            ...
            <style>{`
                ...
                @keyframes starPulse {
                    0%, 100% { opacity: 1; filter: drop-shadow(0 0 2px rgba(250,204,21,0.36)); }
                    50% { opacity: 0.5; filter: drop-shadow(0 0 8px rgba(241,196,14,0.87)); }
                }
                ...
                .hero-stats-fade {
                    animation: heroStatsFade 0.6s ease-out 0.4s both;
                }
                .hero-star-pulse {
